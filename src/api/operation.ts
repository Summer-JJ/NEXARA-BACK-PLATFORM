...
//   return http.request<any>("delete", baseUrlApi(`/operation/orders/${id}/cleanup_file/`));
// };

// 标记订单失败
// export const markOrderFailed = (id: string | number) => {
//   return http.request<any>("post", baseUrlApi(`/operation/orders/${id}/mark_failed/`));
// };
...
export const refundPayment = (id: string | number, data: any) => {
  return http.request<any>("post", baseUrlApi(`/operation/payment/${id}/refund/`),{ data });
};
